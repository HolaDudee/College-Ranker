...
export default function App() {
	...
	togSettings = () => {
		if (settings == "block") {
			setSettings("none"), setMyColleges("none"), setMainDisplay("block");
		} else {
			setSettings("block"), setMainDisplay("none"), setMyColleges("none");
		}
	};
	...
	togMyColleges = () => {
		if (myColleges == "block") {
			...
			setSettings("none"), setMainDisplay("none"), setMyColleges("block");
		}
	};
	...
	setOpenMenuToggle = () => {
		setOpenMenu(true), setValue("select"), setOpen(false);
	};
	...
	const [itemsMenu, setItemsMenu] = useState([
		{
			...
			icon: () => (
				<Image
					source={require("./assets/img/homeIconV2White.png")}
		...
		},
		{
			...
			icon: () => (
				<Image
					source={require("./assets/img/collegeIconWhite.png")}
					style={{ height: 25, width: 25 }}
				/>
			),
		},
		{
			...
			icon: () => (
				<Image
					source={require("./assets/img/settingsGearWheelWhite.png")}
					style={{ height: 25, width: 25 }}
				/>
			),
		},
			...
			<View style={styles.container}>
				...
				<SafeAreaView>
					...
					<View
						style={{
							position: "absolute",
							top: -deviceHeightPart * 3,
							right: 10,
							width: deviceWidth / 15,
							height: deviceHeightPart,
						}}
					>
						<DropDownPicker
							open={openMenu}
						...
						>
							<Image
								source={require("./assets/img/hamburgerMenuIcon.png")}
								style={{ height: taskbarHeight, width: iconWidth }}
							/>
						</TouchableOpacity>
					</View>
					...
					<View style={styles.pages}>
							...
							{valueMenu == "settings" ? (
								<>
									<ScrollView style={{ height: deviceHeightPart * 2 * 16 }}>
										...
										>
											<View style={{ width: (7.3 * deviceWidth) / 10 }}>
												<Text
													style={{
														fontSize: 24,
														fontWeight: "bold",
						...
						<View>
							{valueMenu == "myColleges" ? (
								<>
									<Image
										source={require("./assets/img/collegeIcon.png")}
										style={{
											height: 50,
											width: 50,
											position: "absolute",
                ...
                <View style={{backgroundColor: 'lightblue', height: deviceHeightPart, justifyContent: 'center', width: deviceWidth/2, borderRadius: 15, marginLeft: 5}}><Text>Add New College</Text></View>
									...
									<Image
										source={require("./assets/img/homeIconV2.png")}
										style={{
											height: 50,
											width: 50,
											position: "absolute",
